...
Reactive Programming is booming. It's everywhere - in your browser, on the backend and even in yuor mobile device. This talk is an argument for using reactive approach during mobile development. It explains how we can solve complex problems using relatively simple functional tricks.
