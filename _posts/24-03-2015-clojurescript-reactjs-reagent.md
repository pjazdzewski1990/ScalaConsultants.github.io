...
{% endhighlight %}
(assuming that corresponding React classes are present in JavaScript execution context and named exactly the same as nodes in outlined XML tree)
...
Feel free to express your questions, comments or opinions in the comments.
